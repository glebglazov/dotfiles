...
require('review').setup {
  default_base = get_default_remote_branch,
  keys = {
    ...
    prev_comment      = '[c',
    comment_hunk      = '<Tab>',
    toggle_auto_form  = '<LEADER>rta',
    toggle_signs      = '<LEADER>rts',
    toggle_deleted    = '<LEADER>rtd',
    toggle_resolved   = '<LEADER>rtr',
  },
}

vim.keymap.set('n', '<LEADER>as', function() require('agent_pane').message_popup() end,
  { silent = true, desc = 'Agent: send message to Pop pane' })
