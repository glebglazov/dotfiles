...
Use the following information to understand how to create your document:
    - create your file under `thoughts/shared/handoffs/YYYY-MM-DD_HH-MM-SS_TICKET_ID_description.md`, where:
    ...
    - Run the `~/private/.config/bin/spec_metadata.sh` script to generate all relevant metadata
    - Examples:
        - With ticket: `thoughts/shared/handoffs/2025-01-08_13-55-22_GS_2166_create-context-compaction.md`
        - Without ticket: `thoughts/shared/handoffs/2025-01-08_13-55-22_create-context-compaction.md`
